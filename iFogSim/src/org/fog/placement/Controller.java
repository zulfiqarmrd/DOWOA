...
//			if(dev.getName().equals("cloud01"))
	...
	private void printCostDetails(){
		...
		List<Cloudlet> cloudlets = getCloud().getCloudletListAssignment();
		
		for (Cloudlet cld: cloudlets)
		{
			System.out.println("Cost of all assigned cloudlets = " + cld.getActualCPUTime() * cld.getCostPerSec());
		}
