...
public class FogDevice extends PowerDatacenter {
    ...
    protected double busyPower;		// I add it
    protected double idlePower;		// I add it
    protected double comEC;		// I add it
    ...
    public FogDevice(
            ...
            double ratePerMips,
            double busyPower,	// I add it
    		double idlePower, 	// I add it
    		double comEC) 	// I add it
    				throws Exception {
...
//                        System.out.println(TimeKeeper.getInstance().tupleEndedExecution(tuple));
                        Application application = getApplicationMap().get(tuple.getAppId());
                        Logger.debug(getName(), "Completed execution of tuple " + tuple.getCloudletId() + " on " + tuple.getDestModuleName());
                        System.out.println(getName()+ " Completed execution of tuple " + tuple.getCloudletId() + " on " + tuple.getDestModuleName()+". Start and finish times:" + tuple.getExecStartTime()+", "+tuple.getFinishTime());
 ...
 /************* I add it *****************/
    ...
    public double getComEC() {
        return comEC;
    }
    
    public void setComEC(double comEC) {
        this.comEC = comEC;
    }
